...
act_noise      = 0.0		  # Stddev for Gaussian exploration noise added to policy at training time
...
pi_lr           = 1e-4
pi_hidden_sizes = [400, 300, 300] 	  # Dimensions have to be 1 less than activations
pi_activations  = ['relu', 'relu', 'relu', 'tanh']
pi_optimizer    = 'Adam'

# Q Network Parameters
q_lr      	    = 1e-3
q_hidden_sizes  = [400, 300, 300]	  # Dimensions have to be 1 less than activations
