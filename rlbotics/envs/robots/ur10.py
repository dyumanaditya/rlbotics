...
class UR10:
	def __init__(self, physics_client, base_pos, base_orn, initial_joint_positions=None):
		...
		self.robot_path = os.path.abspath(os.path.join('..', 'models', 'robots', 'universal_robots', 'ur10', 'ur10.urdf'))
		self.gripper_path = os.path.abspath(os.path.join('..', 'models', 'gripper', 'robotiq', 'robotiq_2f_85', 'robotiq_2f_85.urdf'))
